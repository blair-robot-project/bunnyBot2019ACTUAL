...
public class SparkWithMP extends CANSparkMax {
    ...
    private int baseTrajDurationMS;
    ...
    private void setPointReference(TrajectoryPoint point) {
    ...
    public CANError configMotionProfileTrajectoryPeriod(final int baseTrajDurationMs, final int timeoutMs) {
        this.baseTrajDurationMS = baseTrajDurationMs;
        return CANError.kOk;
    }
    ...
    /**
     * The current output mode of the motion profile executor (disabled,
    ...
    ErrorCode pushMPPoint(final TrajectoryPoint pt) {
        ...
        if (getBufferRemaining() <= 0) return ErrorCode.BufferFull;
    ...
    public int getTimeDurMs() {
        return this.baseTrajDurationMS + this.activePoint().timeDur;
    }
